...
export const temas = [
  {
    ...
    description: `La ansiedad es una respuesta natural del cuerpo ante el peligro, pero cuando esta respuesta se desencadena excesivamente en situaciones no peligrosas, se convierte en un trastorno de ansiedad. El estrés es la reacción del cuerpo a desafíos o presiones externas.`
  },
  {
    title: 'Depresión',
  ...
  {
    title: 'Duelo',
    description: `El duelo es la respuesta emocional y física a la pérdida de alguien o algo significativo. Puede implicar
    una amplia gama de emociones. El duelo se convierte en un problema cuando afecta significativamente la capacidad de una persona para funcionar en su vida diaria durante un período de tiempo prolongado.`
  },
  {
  ...
  {
    title: 'Problemas Laborales o Académicos',
    description: `Estos problemas se relacionan con dificultades en el entorno laboral o académico, incluyendo altos niveles de estrés, falta de satisfacción, desempeño insatisfactorio o conflictos en el lugar de trabajo o en la escuela.`
  },
  {
    title: 'Otros',
